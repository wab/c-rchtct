...
<div class="newsection">
  <div class="row columns">
    <div class="intro">
      <?php if(get_field('title-1')): ?>
        <h2 class="section--title scrollreveal"><span><?php the_field('title-1'); ?></span></h2>
      <?php endif; ?>
      <?php if(get_field('lead')): ?>
        <p class="intro-lead scrollreveal"><?php the_field('lead'); ?></p>
      <?php endif; ?>
      <?php if(get_field('main-cta-link')): ?>
        <a href="<?php the_field('main-cta-link'); ?>" class="roundButton scrollreveal"><?php the_field('main-cta-label'); ?></a>
      <?php endif; ?>
    </div>
...
<section class="newsection">
  <div class="row column">
    <h2 class="section--title scrollreveal"><span><?php the_field('title-2'); ?></span></h2>
    <ul class="row no-bullet pros--secteur scrollreveals">
      <li class="columns large-3 medium-6 pros--secteur scrollreveal">
        ...
        <h3 class="pros--title"><?php the_field('pro1-title'); ?></h3>
      ...
      <li class="columns large-3 medium-6 pros--secteur scrollreveal">
        ...
        <h3 class="pros--title"><?php the_field('pro2-title'); ?></h3>
      ...
      <li class="columns large-3 medium-6 pros--secteur scrollreveal">
        ...
        <h3 class="pros--title"><?php the_field('pro3-title'); ?></h3>
      ...
      <li class="columns large-3 medium-6 pros--secteur scrollreveal">
        ...
        <h3 class="pros--title"><?php the_field('pro4-title'); ?></h3>
...
<section class="newsection">
  <div class="row column">
    <h2 class="section--title scrollreveal"><span><?php the_field('title-gallery'); ?></span></h2>
    <?php
    // the query
    ...
    <p class="text-center"><a href="<?php echo get_permalink( $galleryPageID ); ?>" class="roundButton"><?php the_field('cta-gallery-label'); ?></a></p>
  </div>
</section>
