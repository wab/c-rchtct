...
<?php while (have_posts()) : the_post(); ?>
  ...
  <div class="section why">
    ...
    <div class="row">
      ...
      <div class="columns">
        <h2 class="section--title scrollreveal"><span><?php echo __('Why', 'cedar-architect'); ?> <?php bloginfo('title'); ?> ?</span></h2>
      </div>
  ...
  <div class="section">
    ...
    <div class="row column">
      <h2 class="section--title scrollreveal"><span><?php echo __('For professionals', 'cedar-architect'); ?></span></h2>
  ...
  <div class="section feature draw">
    ...
    <div class="feature--wrapper">
      <div class="feature--column"><img src="<?php the_field('f1_img'); ?>" alt="<?php echo __('Design', 'cedar-architect'); ?>"></div>
      <div class="feature--column">
        ...
        <p class="text-right"><a href="<?php the_field('f1_link'); ?>"><?php echo __('Find out more', 'cedar-architect'); ?></a></p>
      </div>
    </div>
  </div>
  ...
  <div class="section feature">
    ...
    <div class="feature--wrapper">
      <div class="feature--column"><img src="<?php the_field('f2_img'); ?>" alt="<?php echo __('Remodel', 'cedar-architect'); ?>"></div>
      <div class="feature--column">
        <h2 class="section--title">
        ...
        <p class="text-right"><a href="<?php the_field('f2_link'); ?>"><?php echo __('Find out more', 'cedar-architect'); ?></a></p>
      </div>
    </div>
  </div>
  ...
  <div class="section feature">
    ...
    <div class="feature--wrapper">
      <div class="feature--column"><img src="<?php the_field('f3_img'); ?>" alt="<?php echo __('Enhance', 'cedar-architect'); ?>"></div>
      <div class="feature--column">
        <h2 class="section--title">
        ...
        <p class="text-right"><a href="<?php the_field('f3_link'); ?>"><?php echo __('Find out more', 'cedar-architect'); ?></a></p>
      </div>
    </div>
  </div>
   ...
   <section class="section home-galerie">
    <div class="row column">
      <h2 class="section--title scrollreveal"><span><?php echo __('Gallery', 'cedar-architect'); ?></span></h2>
      <?php
      // the query
