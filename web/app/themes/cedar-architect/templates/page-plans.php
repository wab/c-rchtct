...
<?php while (have_posts()) : the_post(); ?>
  ...
  <script type="text/javascript">
    ...
    window.cedarLabels = {
      ...
      "projects": "<?php _e('project', 'cedar-architect'); ?>",
      "renderings": "<?php _e('rendering', 'cedar-architect'); ?>",
      "hd-renderings": "<?php _e('HD Rendering', 'cedar-architect'); ?>",
      "print-renderings": "<?php _e('Print Rendering', 'cedar-architect'); ?>",
      "virtual-renderings": "<?php _e('Virtual visit', 'cedar-architect'); ?>",
